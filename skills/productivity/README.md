...
- **[timesheet](./timesheet/SKILL.md)** — Generate a timesheet entry for a given date by grouping the day's git work under its ticket IDs and summarising what was done.
